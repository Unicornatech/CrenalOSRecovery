...
:MAIN
Echo *******************************************************CrenalOS Recovery***************************************************************************************************
echo Welcome to the recovery enviroment
cmdMenuSel f870 "Reinstall" "Update" "exit"
...
:reinstall
Echo Your pc will now start the reset program
reset.bat
:update
